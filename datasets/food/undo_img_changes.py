...
if __name__ == "__main__":
    ...
    destination_image_folder_path = "../food/test/images"

    # Replace this with your desired log file path
    moved_images_file_path = "moved_train_images.txt"

    move_images(log_file="moved_valid_images.txt", source_folder=source_image_folder_path, destination_folder=destination_image_folder_path, moved_images_file=moved_images_file_path)
